...
public struct SsdDetect {
    ...
    */
    ...
    func detectObjects(prediction: SSDOutput, image: UIImage) -> DetectedAllBoxes {
        ...
        let result:ScanResult = predAPI.predictionAPI(scores:normalizedScores, boxes: cornerFormBoxes, probThreshold: SsdDetect.probThreshold, iouThreshold: SsdDetect.iouThreshold, candidateSize: SsdDetect.candidateSize, topK: SsdDetect.topK)
